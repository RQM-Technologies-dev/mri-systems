"""Coil-state construction and packing helpers for QCSM experiments."""
...
def pack_two_complex_channels(z1: complex, z2: complex) -> np.ndarray:
    """Pack two complex channels into one quaternion [Re(z1), Im(z1), Re(z2), Im(z2)]."""
