...
def main() -> None:
    ...
    (output_dir / "summary.md").write_text(
        "# Multicoil fusion summary\n\n"
        "- Data: synthetic phantom with coil-wise phase disagreement\n"
        "- Outputs: baseline and placeholder coherence-aware reconstruction\n"
        "- Note: controlled research demonstration only\n"
    )
